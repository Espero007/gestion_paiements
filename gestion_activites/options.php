...
<ul class="dropdown-menu">
    ...
    <?php if ($titre_page == 'Liste des activités') : ?>
        <?php if ($generer_documents) : ?>
            <li>
                <a href="/gestion_activites/edition_en_ligne.php?id=<?= chiffrer($activite['id']) ?>" class="dropdown-item fs-6 custom-dropdown-item">Editer l'entête de vos fichiers</a>

                <a href="/gestion_activites/generation_documents.php?id_activite=<?= chiffrer($activite['id']) ?>" class="dropdown-item custom-dropdown-item"></i>Générer les documents</a>
            </li>
        <?php endif; ?>
