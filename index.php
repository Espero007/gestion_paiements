...
$stmt = 'SELECT nom, description, periode, centre FROM activites WHERE id_user=' . $_SESSION['user_id'] . ' ORDER BY id DESC LIMIT ' . NBR_ACTIVITES_A_AFFICHER;
