...
function genererNoteService($id_activite, $navigateur = true)
{
    ...
    // Timbre
    $pdf->setFont('trebucbd', '', 10);
    if (!function_exists('nombreEspace')) {
...
/**
 * Elle génère les documents fusionnés
 */
function genererDocumentsFusionnes($id_activite, $navigateur = true)
{
    global $dossier_exports_temp;
    ...
    if ($navigateur) {
        ...
        $chemin_fichier = $dossier_exports_temp . '/Fusion des documents.pdf';
        $pdf->Output($chemin_fichier, 'F');
        return $chemin_fichier;
    }
}
