...
if ($stmt->rowCount() == 1) {
    ...
    if (ConfigurerInformationsDemo()) {
        ...
        $_SESSION['infos_demo_ok'] = 'Les informations de démonstration ont été ajoutées et configurées avec succès ! Utilisez-les pour tester et explorer les différentes fonctionnalités de la plateforme.';
