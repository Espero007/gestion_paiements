...
if (!(isset($page_ajout_participant) && informations_bancaires_skippees())) {
    ...
    // Nous sommes sur la page d'ajout de l'acteur et les informations bancaires ont été skippées donc il n'y a rien à faire à ce niveau. On achève le process comme ça et on retourne sur l'autre page
    // Il n'y a pas eu de traitements dans le cas d'espèce mais c'est plus simple de procéder comme ça.
    $traitement_fichiers_ok = true;
}
