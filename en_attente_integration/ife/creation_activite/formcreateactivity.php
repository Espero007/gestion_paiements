...
// var_dump($ligne);
        ...
        header("location: $url");
        // header('location:../enregistrer_participant.php');
    }
}
?>
...
<body class="container py-4">
    <?php //echo "<h2> Bienvenue sur notre site <i style = 'color:blue'>" . $_SESSION["nom"] . " " . $loggedUser["Prenom"] . "</i> </h2>"; ?>
    <h2>Création d'une Activité de type 1</h2>
    <?php if ($success): ?>
    ...
    <div class=".container">
        <form method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-primary">Créer l'activité</button>
                <!-- <a href="#" class="btn btn-primary">Retourner au dashboard</a> -->
                 <!-- <a href="#" class="btn btn-primary">Débuter l'enregistrement des participants</a> -->
        </form>
    </div>
</body>
