...
<?php echo "<h2>Bienvenue sur notre site <i style='color:blue'>" . $loggedUser["nom"] . " " . $loggedUser["prenoms"] . "</i></h2>"; ?>
    ...
    <?php endif; ?>
    <div class="container">
        <form method="POST" enctype="multipart/form-data" id="activityForm" action="submitActivity.php">
            ...
            <div class="mb-3">
                <label class="form-label">Note génératrice (fichier, obligatoire)</label>
                <input type="file" name="note_generatrice" class="form-control" required>
            ...
            <button type="submit" class="btn btn-primary" id="submitButton">Créer l'activité</button>
        </form>
    </div>
