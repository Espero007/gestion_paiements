...
// require_once ROOT_PATH . '/autres/cle.php'; // La clé est définie ici
// require_once BASE_PATH . '/autres/cle.php'; // La clé est définie ici
// require_once BASE_PATH . '/crypto.php'; // Les fonctions de chiffrement
// require_once ROOT_PATH . '/includes/constantes_utilitaires.php'; // Les fonctions d'aide, dont generateUrl()
...
foreach ($routes as $pattern => $callback) {
    ...
    if (preg_match('#^' . $pattern . '$#', $uri, $matches)) {
        ...
        // $trouve = true;
        return; // Une fois qu'une route est trouvée, on arrête de chercher
    }
}
