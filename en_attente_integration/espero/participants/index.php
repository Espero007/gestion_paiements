...
<body>
    <div class="container-md">
        <h4 class="my-4">Liste des participants</h4>

        <form action="" method="post">
            <div class="row">
                <div class="col-4">
                    <input size=50 class="form-control" type="text" name="valeur" id="rechercher" placeholder="Entrez la valeur à rechercher..."
            ...
            <?php else: ?>
                <?php foreach ($participants as $participant) : ?>
                    ...
                    <div class="boutons">
                        ...
                        <a href="modifier_informations.php?id_participant=<?php echo $participant['id_participant']; ?>"><button class="btn btn-primary">Modifier les informations</button></a>
                    </div>
        ...
        <?php else: ?>
            ...
            <?php else: ?>
                ...
                <?php foreach ($resultats as $resultat) : ?>
                    ...
                    <div class="boutons">
                        <button class="btn btn-primary">Gérer</button>
                        <a href="modifier_informations.php?id_participant=<?php echo $resultat['id_participant']; ?>"><button class="btn btn-primary">Modifier les informations</button></a>
                    </div>
